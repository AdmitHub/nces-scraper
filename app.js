    ...
    request({
      ...
      if (admissions) {
        ...
        if (studentScores) {
          ...
          info.ACTMath25thPercentile = studentScores.parent().parent().parent().find('td:contains("ACT Math")').next().get(0) ? studentScores.parent().parent().parent().find('td:contains("SAT Math")').next().get(0).children[0].data : null;
          info.ACTMath75thPercentile = studentScores.parent().parent().parent().find('td:contains("ACT Math")').next().get(0) ? studentScores.parent().parent().parent().find('td:contains("SAT Math")').next().next().get(0).children[0].data : null;
